...
use p2panda_rs::operation::{
    decode::decode_operation, traits::Schematic, EncodedOperation, OperationId,
};
...
impl Connect for GrpcServer {
    ...
    ) -> Result<Response<DocumentResponse>> {
        let req = request.into_inner();
    ...
    async fn get_next_args(
        &self,
        request: Request<NextArgsRequest>,
